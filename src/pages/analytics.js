            ...
            <div className="px-4 sm:px-6 lg:px-8 py-6">
              ...
              <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  {[
                    { title: "Total Storage", value: "0.00 MB", subtitle: "0 files", icon: <HardDrive className="w-6 h-6 text-indigo-600" />, iconBg: "bg-indigo-100" },
                    { title: "Average File Size", value: "0.00 MB", subtitle: "per file", icon: <ChartColumn className="w-6 h-6 text-purple-600" />, iconBg: "bg-purple-100" },
                    { title: "Growth Rate", value: "+0", subtitle: "files this week", icon: <TrendingUp className="w-6 h-6 text-green-600" />, iconBg: "bg-green-100" },
